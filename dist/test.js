...
(0, node_test_1.describe)("PolicyRegistry", () => {
    (0, node_test_1.test)("default allow/deny/ask registered", () => {
        const reg = new policy_registry_1.PolicyRegistry();
        node_assert_1.default.strictEqual(reg.resolve({ policy: "allow", priority: 1 }).decision, "allow");
        node_assert_1.default.strictEqual(reg.resolve({ policy: "deny", priority: 2 }).decision, "deny");
        node_assert_1.default.strictEqual(reg.resolve({ policy: "ask", priority: 3 }).decision, "ask");
    });
    (0, node_test_1.test)("unknown policy defaults to ask", () => {
        const reg = new policy_registry_1.PolicyRegistry();
        node_assert_1.default.deepStrictEqual(reg.resolve({ policy: "unknown" }), { decision: "ask", priority: 0 });
    });
});
(0, node_test_1.describe)("Config loader", () => {
    ...
    (0, node_test_1.test)("resolveRules picks last matching highest priority", () => {
        ...
        node_assert_1.default.strictEqual(result.policy, "deny");
    });
});
