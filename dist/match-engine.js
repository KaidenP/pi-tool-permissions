...
import { parameterValueToString, isPathParameter } from "./parameter-normalizer.js";
...
export function normalizePathPattern(pattern, cwd = process.cwd(), homeDir = homedir()) {
